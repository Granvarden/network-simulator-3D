...
class GraphicsConfig:
    ...
    COLOR_LED_GREEN: Tuple[float, float, float] = (0.10, 0.98, 0.25)
    COLOR_LED_AMBER: Tuple[float, float, float] = (0.98, 0.68, 0.08)
    COLOR_LED_OFF: Tuple[float, float, float] = (0.12, 0.14, 0.13)
    COLOR_LED_ACTIVITY: Tuple[float, float, float] = (0.35, 1.00, 0.45)
    COLOR_LED_CONSOLE: Tuple[float, float, float] = (0.18, 0.78, 0.98)
    COLOR_LED_BEZEL: Tuple[float, float, float] = (0.06, 0.07, 0.09)
